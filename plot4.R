...
# 1st plot: plot line plot of the global active power variable over time
plot(x = data2$DateTime, y = data2$Global_active_power, 
     ylab = "Global Active Power (kilowatts)", xlab="",
     type = "l")

# 2nd plot: plot sub metering variables over time
...
# 3rd plot: plot voltage over time
plot(x = data2$DateTime, y = data2$Voltage, 
     ylab = "Voltage", xlab="datetime",
     type = "l")

# 4th plot: plot global reactice power over time
